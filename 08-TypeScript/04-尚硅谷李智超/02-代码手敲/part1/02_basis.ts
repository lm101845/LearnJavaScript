 ...
 * @LastEditTime: 2021-09-11 19:14:31
 * @FilePath: \08-TypeScript\02-尚硅谷李智超\02-代码手敲\part1\02_basis.ts
 */
// let a;
// a = 10;
// a = 'hello'
...
// 如果变量的声明和赋值是【同时进行】的，那么TS就可以自动对变量进行类型检测

// 疑问：既然TS编译器可以自动判断变量类型，那我们手动写类型是否多此一举呢？
// 回答：类型给我们带来的困扰最大的往往不是变量，而是【函数】
...
// 鼠标悬停到result上可以看到result的类型为number
export { }
